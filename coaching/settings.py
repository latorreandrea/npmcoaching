...
ASSESSMENTS_GUEST_RESULT_RETENTION_DAYS = int(os.environ.get('ASSESSMENTS_GUEST_RESULT_RETENTION_DAYS', '14'))
ASSESSMENTS_GUEST_RATE_LIMIT_COUNT = int(os.environ.get('ASSESSMENTS_GUEST_RATE_LIMIT_COUNT', '5'))
ASSESSMENTS_GUEST_RATE_LIMIT_WINDOW_SECONDS = int(os.environ.get('ASSESSMENTS_GUEST_RATE_LIMIT_WINDOW_SECONDS', '60'))
ASSESSMENTS_GUEST_CONSENT_POLICY_VERSION = os.environ.get('ASSESSMENTS_GUEST_CONSENT_POLICY_VERSION', '2026-02')
